...
import { ArrowLeft, Cpu, Globe, Mic, Video } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div className="relative group">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-gray-900 border border-gray-700 aspect-video flex items-center justify-center shadow-2xl">
              {/* Placeholder for AI Generated Video */}
              <div className="absolute inset-0 bg-black/60 z-10 flex flex-col items-center justify-center text-center p-6">
                ...
                <p className="text-sm text-gray-500 max-w-xs mt-2">
                  A visual journey through time generated by Sora/Runway.
                </p>
              </div>
              ...
              <img
                src={
                  import.meta.env.VITE_DEMO_VIDEO_THUMBNAIL_URL ||
                  "https://images.unsplash.com/photo-1614726365723-49cfae963fcb?q=80&w=1974&auto=format&fit=crop"
                }
                alt="Abstract Time Tunnel"
